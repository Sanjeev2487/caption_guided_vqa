...
wget -P data http://www.cs.utexas.edu/~jialinwu/dataset/VQA_caption_traindataset.pkl
wget -P data http://www.cs.utexas.edu/~jialinwu/dataset/VQA_caption_valdataset.pkl
